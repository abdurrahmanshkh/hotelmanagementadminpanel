...
@Component({
  ...
  template: `
    <div class="toast-container">
      ...
      >
        <app-icon [name]="getIcon(toast.type)" [size]="18" [color]="getIconColor(toast.type)"></app-icon>
  ...
  styles: [`
    ...
    .toast {
      ...
      &__content { flex: 1; }
      &__title { font-size: 0.875rem; font-weight: 700; color: #0F172A; margin-bottom: 0.125rem; }
      &__message { font-size: 0.8125rem; color: #475569; line-height: 1.4; }
      &__close { background: none; border: none; cursor: pointer; padding: 0.125rem; }
    }

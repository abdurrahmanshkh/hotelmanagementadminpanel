...
public class RegisterRequestDto {
    ...
    public RegisterRequestDto(String firstName, String lastName, String email, String phone, String dateOfBirth, String governmentIdType, String governmentIdNumber, String password) {

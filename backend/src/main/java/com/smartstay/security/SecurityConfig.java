    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/rooms/**", "/api/v1/room-types/**").permitAll()

                        // Admin & Staff endpoints
                        .requestMatchers("/api/v1/admin/**").hasAnyRole("ADMIN", "MANAGER", "STAFF")

                        // Customer protected endpoints
                        .requestMatchers("/api/v1/customer/**", "/api/v1/bookings/**", "/api/v1/payments/**", "/api/v1/passcodes/**").authenticated()
